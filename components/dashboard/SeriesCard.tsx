...
export function SeriesCard({ series, onDelete, onStatusChange }: SeriesCardProps) {
        ...
        >
            ...
            <CardContent className="p-4 space-y-2">
                <div className="flex items-start justify-between gap-2">
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-48">
                            ...
                            <DropdownMenuItem onClick={handlePauseResume} className="gap-2 cursor-pointer">
                ...
                <div className="flex items-center gap-2 text-xs text-muted-foreground">
                    ...
                    <span>Created {formatDistanceToNow(new Date(series.created_at), { addSuffix: true })}</span>
                </div>
            </CardContent>

            <CardFooter className="p-4 pt-0 grid grid-cols-2 gap-2">
                <Button variant="outline" size="sm" className="w-full text-[11px] gap-1.5 h-8 font-semibold">
